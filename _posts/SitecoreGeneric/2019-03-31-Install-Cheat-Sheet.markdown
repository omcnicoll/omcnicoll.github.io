...
3. Setup SOLR to run as a service with NSSM
  ...
  ![Expected-NSSM-Dialog-Values]({{ site.baseurl }}/images/posts/2019-04-01-Install-Cheat-Sheet/nssm.jpg){:class="img-responsive"}
...
![Expected-Directory-Structure]({{ site.baseurl }}/images/posts/2019-04-01-Install-Cheat-Sheet/InstallFolder.jpg){:class="img-responsive"}
